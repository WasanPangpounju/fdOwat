...
let addSalaryDaily = [];
    ...
    if(dataRate?.dayType === 'specialDayOff') {
      ...
      cashWork = await (parseFloat(record.totalTime || 0) * parseFloat(salary || 0) * parseFloat(dataRate?.holiday || 0)) || 0;
      console.log('totalTime ' + parseFloat(record.totalTime || 0) + ' salary ' +   parseFloat(salary || 0) + ' dataRate ' + parseFloat(dataRate?.holiday || 0)) 
