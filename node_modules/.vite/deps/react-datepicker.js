...
} from "./chunk-IQPAASPD.js";
import {
  require_react_dom
} from "./chunk-CUXBUD3H.js";
import {
  require_react
...
var Ct = react_onclickoutside_es_default(function(n) {
  De(a3, import_react.default.Component);
  var o = be(a3);
  function a3(r2) {
    var n2;
    he(this, a3), ye(we(n2 = o.call(this, r2)), "renderOptions", function() {
      var t3 = n2.props.year, r3 = n2.state.yearsList.map(function(r4) {
        return import_react.default.createElement("div", { className: t3 === r4 ? "react-datepicker__year-option react-datepicker__year-option--selected_year" : "react-datepicker__year-option", key: r4, onClick: n2.onChange.bind(we(n2), r4), "aria-selected": t3 === r4 ? "true" : void 0 }, t3 === r4 ? import_react.default.createElement("span", { className: "react-datepicker__year-option--selected" }, "✓") : "", r4);
      ...
      return a4 && n2.state.yearsList.find(function(e3) {
        return e3 === a4;
      }) || r3.unshift(import_react.default.createElement("div", { className: "react-datepicker__year-option", key: "upcoming", onClick: n2.incrementYears }, import_react.default.createElement("a", { className: "react-datepicker__navigation react-datepicker__navigation--years react-datepicker__navigation--years-upcoming" }))), o2 && n2.state.yearsList.find(function(e3) {
        return e3 === o2;
      }) || r3.push(import_react.default.createElement("div", { className: "react-datepicker__year-option", key: "previous", onClick: n2.decrementYears }, import_react.default.createElement("a", { className: "react-datepicker__navigation react-datepicker__navigation--years react-datepicker__navigation--years-previous" }))), r3;
    ...
    return n2.state = { yearsList: St(n2.props.year, p, n2.props.minDate, n2.props.maxDate) }, n2.dropdownRef = (0, import_react.createRef)(), n2;
  }
  return fe(a3, [{ key: "componentDidMount", value: function() {
    ...
    return import_react.default.createElement("div", { className: t3, ref: this.dropdownRef }, this.renderOptions());
  } }]), a3;
}());
var _t = function(t3) {
  De(n, import_react.default.Component);
  var r2 = be(n);
  function n() {
    var t4;
    he(this, n);
    ...
    return ye(we(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { dropdownVisible: false }), ye(we(t4), "renderSelectOptions", function() {
      for (var r3 = t4.props.minDate ? getYear(t4.props.minDate) : 1900, n2 = t4.props.maxDate ? getYear(t4.props.maxDate) : 2100, o2 = [], a4 = r3; a4 <= n2; a4++)
        o2.push(import_react.default.createElement("option", { key: a4, value: a4 }, a4));
      return o2;
    }), ye(we(t4), "onSelectChange", function(e3) {
      t4.onChange(e3.target.value);
    }), ye(we(t4), "renderSelectMode", function() {
      return import_react.default.createElement("select", { value: t4.props.year, className: "react-datepicker__year-select", onChange: t4.onSelectChange }, t4.renderSelectOptions());
    }), ye(we(t4), "renderReadView", function(r3) {
      return import_react.default.createElement("div", { key: "read", style: { visibility: r3 ? "visible" : "hidden" }, className: "react-datepicker__year-read-view", onClick: function(e3) {
        return t4.toggleDropdown(e3);
      } }, import_react.default.createElement("span", { className: "react-datepicker__year-read-view--down-arrow" }), import_react.default.createElement("span", { className: "react-datepicker__year-read-view--selected-year" }, t4.props.year));
    }), ye(we(t4), "renderDropdown", function() {
      return import_react.default.createElement(Ct, { key: "dropdown", year: t4.props.year, onChange: t4.onChange, onCancel: t4.toggleDropdown, minDate: t4.props.minDate, maxDate: t4.props.maxDate, scrollableYearDropdown: t4.props.scrollableYearDropdown, yearDropdownItemNumber: t4.props.yearDropdownItemNumber });
  ...
  return fe(n, [{ key: "render", value: function() {
    ...
    return import_react.default.createElement("div", { className: "react-datepicker__year-dropdown-container react-datepicker__year-dropdown-container--".concat(this.props.dropdownMode) }, t4);
  } }]), n;
}();
var Mt = react_onclickoutside_es_default(function(t3) {
  ...
  function n() {
    ...
    return ye(we(t4 = r2.call.apply(r2, [this].concat(a3))), "isSelectedMonth", function(e3) {
      ...
      return t4.props.monthNames.map(function(r3, n2) {
        return import_react.default.createElement("div", { className: t4.isSelectedMonth(n2) ? "react-datepicker__month-option react-datepicker__month-option--selected_month" : "react-datepicker__month-option", key: r3, onClick: t4.onChange.bind(we(t4), n2), "aria-selected": t4.isSelectedMonth(n2) ? "true" : void 0 }, t4.isSelectedMonth(n2) ? import_react.default.createElement("span", { className: "react-datepicker__month-option--selected" }, "✓") : "", r3);
      });
    }), ye(we(t4), "onChange", function(e3) {
  ...
  return fe(n, [{ key: "render", value: function() {
    return import_react.default.createElement("div", { className: "react-datepicker__month-dropdown" }, this.renderOptions());
  } }]), n;
}());
var Pt = function(t3) {
  De(n, import_react.default.Component);
  ...
  function n() {
    ...
    return ye(we(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { dropdownVisible: false }), ye(we(t4), "renderSelectOptions", function(t5) {
      return t5.map(function(t6, r3) {
        return import_react.default.createElement("option", { key: r3, value: r3 }, t6);
      });
    }), ye(we(t4), "renderSelectMode", function(r3) {
      return import_react.default.createElement("select", { value: t4.props.month, className: "react-datepicker__month-select", onChange: function(e3) {
        return t4.onChange(e3.target.value);
      } }, t4.renderSelectOptions(r3));
    }), ye(we(t4), "renderReadView", function(r3, n2) {
      return import_react.default.createElement("div", { key: "read", style: { visibility: r3 ? "visible" : "hidden" }, className: "react-datepicker__month-read-view", onClick: t4.toggleDropdown }, import_react.default.createElement("span", { className: "react-datepicker__month-read-view--down-arrow" }), import_react.default.createElement("span", { className: "react-datepicker__month-read-view--selected-month" }, n2[t4.props.month]));
    }), ye(we(t4), "renderDropdown", function(r3) {
      return import_react.default.createElement(Mt, { key: "dropdown", month: t4.props.month, monthNames: r3, onChange: t4.onChange, onCancel: t4.toggleDropdown });
  ...
  return fe(n, [{ key: "render", value: function() {
    ...
    return import_react.default.createElement("div", { className: "react-datepicker__month-dropdown-container react-datepicker__month-dropdown-container--".concat(this.props.dropdownMode) }, t4);
  } }]), n;
}();
function Et(e3, t3) {
...
var Nt = react_onclickoutside_es_default(function(t3) {
  De(o, import_react.default.Component);
  var n = be(o);
  function o(t4) {
    var r2;
    return he(this, o), ye(we(r2 = n.call(this, t4)), "renderOptions", function() {
      return r2.state.monthYearsList.map(function(t5) {
        ...
        return import_react.default.createElement("div", { className: o2 ? "react-datepicker__month-year-option--selected_month-year" : "react-datepicker__month-year-option", key: n2, onClick: r2.onChange.bind(we(r2), n2), "aria-selected": o2 ? "true" : void 0 }, o2 ? import_react.default.createElement("span", { className: "react-datepicker__month-year-option--selected" }, "✓") : "", Ie(t5, r2.props.dateFormat, r2.props.locale));
      });
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    return import_react.default.createElement("div", { className: t4 }, this.renderOptions());
  } }]), o;
}());
var xt = function(t3) {
  De(n, import_react.default.Component);
  ...
  function n() {
    ...
    return ye(we(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { dropdownVisible: false }), ye(we(t4), "renderSelectOptions", function() {
      for (var r3 = Fe(t4.props.minDate), n2 = Fe(t4.props.maxDate), o2 = []; !isAfter(r3, n2); ) {
        var a4 = getTime(r3);
        o2.push(import_react.default.createElement("option", { key: a4, value: a4 }, Ie(r3, t4.props.dateFormat, t4.props.locale))), r3 = addMonths(r3, 1);
      }
      return o2;
    }), ye(we(t4), "onSelectChange", function(e3) {
      t4.onChange(e3.target.value);
    }), ye(we(t4), "renderSelectMode", function() {
      return import_react.default.createElement("select", { value: getTime(Fe(t4.props.date)), className: "react-datepicker__month-year-select", onChange: t4.onSelectChange }, t4.renderSelectOptions());
    }), ye(we(t4), "renderReadView", function(r3) {
      var n2 = Ie(t4.props.date, t4.props.dateFormat, t4.props.locale);
      return import_react.default.createElement("div", { key: "read", style: { visibility: r3 ? "visible" : "hidden" }, className: "react-datepicker__month-year-read-view", onClick: function(e3) {
        return t4.toggleDropdown(e3);
      } }, import_react.default.createElement("span", { className: "react-datepicker__month-year-read-view--down-arrow" }), import_react.default.createElement("span", { className: "react-datepicker__month-year-read-view--selected-month-year" }, n2));
    }), ye(we(t4), "renderDropdown", function() {
      return import_react.default.createElement(Nt, { key: "dropdown", date: t4.props.date, dateFormat: t4.props.dateFormat, onChange: t4.onChange, onCancel: t4.toggleDropdown, minDate: t4.props.minDate, maxDate: t4.props.maxDate, scrollableMonthYearDropdown: t4.props.scrollableMonthYearDropdown, locale: t4.props.locale });
    }), ye(we(t4), "renderScrollMode", function() {
      var e3 = t4.state.dropdownVisible, r3 = [t4.renderReadView(!e3)];
      return e3 && r3.unshift(t4.renderDropdown()), r3;
    }), ye(we(t4), "onChange", function(e3) {
  ...
  return fe(n, [{ key: "render", value: function() {
    ...
    return import_react.default.createElement("div", { className: "react-datepicker__month-year-dropdown-container react-datepicker__month-year-dropdown-container--".concat(this.props.dropdownMode) }, t4);
  } }]), n;
}();
var Yt = function(t3) {
  De(o, import_react.default.Component);
  ...
  function o() {
    ...
    for (var a3 = arguments.length, s3 = new Array(a3), i2 = 0; i2 < a3; i2++)
      s3[i2] = arguments[i2];
    return ye(we(t4 = n.call.apply(n, [this].concat(s3))), "dayEl", import_react.default.createRef()), ye(we(t4), "handleClick", function(e3) {
      ...
      return import_react.default.createElement("div", { ref: t4.dayEl, className: t4.getClassNames(t4.props.day), onKeyDown: t4.handleOnKeyDown, onClick: t4.handleClick, onMouseEnter: t4.handleMouseEnter, tabIndex: t4.getTabIndex(), "aria-label": t4.getAriaLabel(), role: "option", title: t4.getTitle(), "aria-disabled": t4.isDisabled(), "aria-current": t4.isCurrentDay() ? "date" : void 0, "aria-selected": t4.isSelected() || t4.isInRange() }, t4.renderDayContents(), "" !== t4.getTitle() && import_react.default.createElement("span", { className: "holiday-overlay" }, t4.getTitle()));
    }), t4;
  }
...
var Tt = function(t3) {
  ...
  function o() {
    ...
    for (var r2 = arguments.length, a3 = new Array(r2), s3 = 0; s3 < r2; s3++)
      a3[s3] = arguments[s3];
    return ye(we(t4 = n.call.apply(n, [this].concat(a3))), "weekNumberEl", import_react.default.createRef()), ye(we(t4), "handleClick", function(e3) {
  ...
  return fe(o, [{ key: "componentDidMount", value: function() {
    ...
    return import_react.default.createElement("div", { ref: this.weekNumberEl, className: (0, import_classnames.default)(s3), "aria-label": "".concat(a3, " ").concat(this.props.weekNumber), onClick: this.handleClick, onKeyDown: this.handleOnKeyDown, tabIndex: this.getTabIndex() }, n2);
...
var It = function(t3) {
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    return import_react.default.createElement("div", { className: (0, import_classnames.default)(t4) }, this.renderDays());
  } }], [{ key: "defaultProps", get: function() {
...
var Wt = function(t3) {
  ...
  function o() {
    ...
    return ye(we(t4 = n.call.apply(n, [this].concat(s3))), "MONTH_REFS", Se(Array(12)).map(function() {
      ...
      return Ft[At(o2, n2)].grid.map(function(r3, n3) {
        return import_react.default.createElement("div", { className: "react-datepicker__month-wrapper", key: n3 }, r3.map(function(r4, n4) {
          return import_react.default.createElement("div", { ref: t4.MONTH_REFS[r4], key: n4, onClick: function(e3) {
      ...
      return import_react.default.createElement("div", { className: "react-datepicker__quarter-wrapper" }, [1, 2, 3, 4].map(function(r3, a4) {
        return import_react.default.createElement("div", { key: a4, ref: t4.QUARTER_REFS[a4], role: "option", onClick: function(e3) {
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    return import_react.default.createElement("div", { className: this.getClassNames(), onMouseLeave: this.handleMouseLeave, "aria-label": "".concat(s3, " ").concat(Ie(o2, "yyyy-MM")), role: "listbox" }, r2 ? this.renderMonths() : n2 ? this.renderQuarters() : this.renderWeeks());
  } }]), o;
}();
var Kt = function(t3) {
  De(n, import_react.default.Component);
  ...
  function n() {
    ...
    return ye(we(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { height: null }), ye(we(t4), "scrollToTheSelectedTime", function() {
      ...
      return r3.map(function(r4, o3) {
        return import_react.default.createElement("li", { key: o3, onClick: t4.handleClick.bind(we(t4), r4), className: t4.liClasses(r4), ref: function(e3) {
  ...
  return fe(n, [{ key: "componentDidMount", value: function() {
    ...
    return import_react.default.createElement("div", { className: "react-datepicker__time-container ".concat(this.props.todayButton ? "react-datepicker__time-container--with-today-button" : "") }, import_react.default.createElement("div", { className: "react-datepicker__header react-datepicker__header--time ".concat(this.props.showTimeSelectOnly ? "react-datepicker__header--time--only" : ""), ref: function(e3) {
      t4.header = e3;
    } }, import_react.default.createElement("div", { className: "react-datepicker-time__header" }, this.props.timeCaption)), import_react.default.createElement("div", { className: "react-datepicker__time" }, import_react.default.createElement("div", { className: "react-datepicker__time-box" }, import_react.default.createElement("ul", { className: "react-datepicker__time-list", ref: function(e3) {
      t4.list = e3;
...
var Bt = function(t3) {
  ...
  return fe(o, [{ key: "render", value: function() {
    for (var t4 = this, r2 = [], n2 = this.props, o2 = n2.date, a3 = n2.yearItemNumber, s3 = n2.onYearMouseEnter, i2 = n2.onYearMouseLeave, p = wt(o2, a3), c2 = p.startPeriod, l = p.endPeriod, d3 = function(n3) {
      r2.push(import_react.default.createElement("div", { ref: t4.YEAR_REFS[n3 - c2], onClick: function(e3) {
      ...
      d3(u2);
    return import_react.default.createElement("div", { className: this.getYearContainerClassNames() }, import_react.default.createElement("div", { className: "react-datepicker__year-wrapper", onMouseLeave: this.props.clearSelectingDate }, r2));
  } }]), o;
}();
var Qt = function(t3) {
  De(n, import_react.default.Component);
  ...
  function n(t4) {
    ...
    return he(this, n), ye(we(o = r2.call(this, t4)), "onTimeChange", function(e3) {
      ...
      return s3 ? import_react.default.cloneElement(s3, { date: n2, value: t5, onChange: o.onTimeChange }) : import_react.default.createElement("input", { type: "time", className: "react-datepicker-time__input", placeholder: "Time", name: "time-input", required: true, value: t5, onChange: function(e3) {
        o.onTimeChange(e3.target.value || a3);
      } });
    }), o.state = { time: o.props.timeString }, o;
  }
  return fe(n, [{ key: "render", value: function() {
    return import_react.default.createElement("div", { className: "react-datepicker__input-time-container" }, import_react.default.createElement("div", { className: "react-datepicker-time__caption" }, this.props.timeInputLabel), import_react.default.createElement("div", { className: "react-datepicker-time__input-container" }, import_react.default.createElement("div", { className: "react-datepicker-time__input" }, this.renderTimeInput())));
...
function Ht(t3) {
  ...
  return import_react.default.createElement("div", { className: r2 }, o && import_react.default.createElement("div", ve({ className: "react-datepicker__triangle" }, s3)), n);
}
...
var Vt = function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ye(we(a3 = n.call(this, t4)), "handleClickOutside", function(e3) {
      ...
      return a3.props.showWeekNumbers && n2.push(import_react.default.createElement("div", { key: "W", className: "react-datepicker__day-name" }, a3.props.weekLabel || "#")), n2.concat([0, 1, 2, 3, 4, 5, 6].map(function(n3) {
        ...
        return import_react.default.createElement("div", { key: n3, className: (0, import_classnames.default)("react-datepicker__day-name", i2) }, s3);
      }));
      ...
      if (!a3.props.renderCustomHeader) {
        ...
        if ((a3.props.forceShowMonthNavigation || a3.props.showDisabledMonthNavigation || !t5) && !a3.props.showTimeSelectOnly) {
          ...
          return import_react.default.createElement("button", { type: "button", className: r2.join(" "), onClick: n2, onKeyDown: a3.props.handleOnKeyDown, "aria-label": o2 ? h3 : d3 }, import_react.default.createElement("span", { className: ["react-datepicker__navigation-icon", "react-datepicker__navigation-icon--previous"].join(" ") }, o2 ? a3.props.previousYearButtonLabel : a3.props.previousMonthButtonLabel));
        }
      }
      ...
      if (!a3.props.renderCustomHeader) {
        ...
        if ((a3.props.forceShowMonthNavigation || a3.props.showDisabledMonthNavigation || !t5) && !a3.props.showTimeSelectOnly) {
          ...
          return import_react.default.createElement("button", { type: "button", className: r2.join(" "), onClick: n2, onKeyDown: a3.props.handleOnKeyDown, "aria-label": o2 ? m3 : d3 }, import_react.default.createElement("span", { className: ["react-datepicker__navigation-icon", "react-datepicker__navigation-icon--next"].join(" ") }, o2 ? a3.props.nextYearButtonLabel : a3.props.nextMonthButtonLabel));
        }
      }
      ...
      return a3.props.showYearDropdown && r2.push("react-datepicker__current-month--hasYearDropdown"), a3.props.showMonthDropdown && r2.push("react-datepicker__current-month--hasMonthDropdown"), a3.props.showMonthYearDropdown && r2.push("react-datepicker__current-month--hasMonthYearDropdown"), import_react.default.createElement("div", { className: r2.join(" ") }, Ie(t5, a3.props.dateFormat, a3.props.locale));
      ...
      if (a3.props.showYearDropdown && !t5)
        return import_react.default.createElement(_t, { adjustDateOnChange: a3.props.adjustDateOnChange, date: a3.state.date, onSelect: a3.props.onSelect, setOpen: a3.props.setOpen, dropdownMode: a3.props.dropdownMode, onChange: a3.changeYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, year: getYear(a3.state.date), scrollableYearDropdown: a3.props.scrollableYearDropdown, yearDropdownItemNumber: a3.props.yearDropdownItemNumber });
    }), ye(we(a3), "renderMonthDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthDropdown && !t5)
        return import_react.default.createElement(Pt, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, onChange: a3.changeMonth, month: getMonth(a3.state.date), useShortMonthInDropdown: a3.props.useShortMonthInDropdown });
    }), ye(we(a3), "renderMonthYearDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthYearDropdown && !t5)
        return import_react.default.createElement(xt, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, dateFormat: a3.props.dateFormat, onChange: a3.changeMonthYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, date: a3.state.date, scrollableMonthYearDropdown: a3.props.scrollableMonthYearDropdown });
      ...
      if (a3.props.todayButton && !a3.props.showTimeSelectOnly)
        return import_react.default.createElement("div", { className: "react-datepicker__today-button", onClick: function(e3) {
      ...
      return import_react.default.createElement("div", { className: "react-datepicker__header ".concat(a3.props.showTimeSelect ? "react-datepicker__header--has-time-select" : "") }, a3.renderCurrentMonth(r2), import_react.default.createElement("div", { className: "react-datepicker__header__dropdown react-datepicker__header__dropdown--".concat(a3.props.dropdownMode), onFocus: a3.handleDropdownFocus }, a3.renderMonthDropdown(0 !== n2), a3.renderMonthYearDropdown(0 !== n2), a3.renderYearDropdown(0 !== n2)), import_react.default.createElement("div", { className: "react-datepicker__day-names" }, a3.header(r2)));
      ...
      return import_react.default.createElement("div", { className: "react-datepicker__header react-datepicker__header--custom", onFocus: a3.props.onDropdownFocus }, a3.props.renderCustomHeader(de(de({}, a3.state), {}, { customHeaderCount: n2, monthDate: r2, changeMonth: a3.changeMonth, changeYear: a3.changeYear, decreaseMonth: a3.decreaseMonth, increaseMonth: a3.increaseMonth, decreaseYear: a3.decreaseYear, increaseYear: a3.increaseYear, prevMonthButtonDisabled: o2, nextMonthButtonDisabled: s3, prevYearButtonDisabled: i2, nextYearButtonDisabled: p })), c2 && import_react.default.createElement("div", { className: "react-datepicker__day-names" }, a3.header(r2)));
      ...
      return import_react.default.createElement("div", { className: "react-datepicker__header react-datepicker-year-header" }, n2 ? "".concat(s3, " - ").concat(i2) : getYear(t5));
      ...
      if (a3.props.showTimeInput)
        return import_react.default.createElement(Qt, { date: t5, timeString: r2, timeInputLabel: a3.props.timeInputLabel, onChange: a3.props.onTimeChange, customTimeInput: a3.props.customTimeInput });
      ...
      return t5 = a3.props.showYearPicker ? "".concat(n2, " - ").concat(o2) : a3.props.showMonthYearPicker || a3.props.showQuarterYearPicker ? getYear(a3.state.date) : "".concat(Je(getMonth(a3.state.date), a3.props.locale), " ").concat(getYear(a3.state.date)), import_react.default.createElement("span", { role: "alert", "aria-live": "polite", className: "react-datepicker__aria-live" }, a3.state.isRenderAriaLiveMessage && t5);
    }), ye(we(a3), "renderChildren", function() {
      if (a3.props.children)
        return import_react.default.createElement("div", { className: "react-datepicker__children-container" }, a3.props.children);
    }), a3.containerRef = import_react.default.createRef(), a3.state = { date: a3.getDateInView(), selectingDate: null, monthContainer: null, isRenderAriaLiveMessage: false }, a3;
  }
  return fe(o, [{ key: "componentDidMount", value: function() {
    var e3 = this;
    ...
    return import_react.default.createElement("div", { style: { display: "contents" }, ref: this.containerRef }, import_react.default.createElement(t4, { className: (0, import_classnames.default)("react-datepicker", this.props.className, { "react-datepicker--time-only": this.props.showTimeSelectOnly }), showPopperArrow: this.props.showPopperArrow, arrowProps: this.props.arrowProps }, this.renderAriaLiveRegion(), this.renderPreviousButton(), this.renderNextButton(), this.renderMonths(), this.renderYears(), this.renderTodayButton(), this.renderTimeSection(), this.renderInputTimeSection(), this.renderChildren()));
  } }], [{ key: "defaultProps", get: function() {
...
var qt = function(t3) {
  ...
  return import_react.default.isValidElement(r2) ? import_react.default.cloneElement(r2, { className: "".concat(r2.props.className || "", " ").concat(s3, " ").concat(o), onClick: function(e3) {
    "function" == typeof r2.props.onClick && r2.props.onClick(e3), "function" == typeof a3 && a3(e3);
  } }) : "string" == typeof r2 ? import_react.default.createElement("i", { className: "".concat(s3, " ").concat(r2, " ").concat(o), "aria-hidden": "true", onClick: a3 }) : import_react.default.createElement("svg", { className: "".concat(s3, " ").concat(o), xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", onClick: a3 }, import_react.default.createElement("path", { d: "M96 32V64H48C21.5 64 0 85.5 0 112v48H448V112c0-26.5-21.5-48-48-48H352V32c0-17.7-14.3-32-32-32s-32 14.3-32 32V64H160V32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192H0V464c0 26.5 21.5 48 48 48H400c26.5 0 48-21.5 48-48V192z" }));
};
var Ut = function(t3) {
  De(n, import_react.default.Component);
  var r2 = be(n);
...
var $t = function(t3) {
  ...
  function n(t4) {
    ...
    }), o.tabLoopRef = import_react.default.createRef(), o;
  }
  return fe(n, [{ key: "render", value: function() {
    return this.props.enableTabLoop ? import_react.default.createElement("div", { className: "react-datepicker__tab-loop", ref: this.tabLoopRef }, import_react.default.createElement("div", { className: "react-datepicker__tab-loop__start", tabIndex: "0", onFocus: this.handleFocusStart }), this.props.children, import_react.default.createElement("div", { className: "react-datepicker__tab-loop__end", tabIndex: "0", onFocus: this.handleFocusEnd })) : this.props.children;
  } }], [{ key: "defaultProps", get: function() {
...
var Gt = function(t3) {
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    if (!s3) {
      ...
      t4 = import_react.default.createElement(Popper, ve({ modifiers: p, placement: c2 }, l), function(t5) {
        var r2 = t5.ref, n3 = t5.style, o3 = t5.placement, a4 = t5.arrowProps;
        return import_react.default.createElement($t, { enableTabLoop: u2 }, import_react.default.createElement("div", { ref: r2, style: n3, className: y3, "data-placement": o3, onKeyDown: h3 }, import_react.default.cloneElement(i2, { arrowProps: a4 })));
      });
    }
    this.props.popperContainer && (t4 = import_react.default.createElement(this.props.popperContainer, {}, t4)), m3 && !s3 && (t4 = import_react.default.createElement(Ut, { portalId: m3, portalHost: f }, t4));
    var v = (0, import_classnames.default)("react-datepicker-wrapper", a3);
    return import_react.default.createElement(Manager, { className: "react-datepicker-manager" }, import_react.default.createElement(Reference, null, function(t5) {
      var r2 = t5.ref;
      return import_react.default.createElement("div", { ref: r2, className: v }, d3);
    }), t4);
  } }], [{ key: "defaultProps", get: function() {
...
var er = function(t3) {
  De(s3, import_react.default.Component);
  var a3 = be(s3);
  function s3(t4) {
    var i2;
    return he(this, s3), ye(we(i2 = a3.call(this, t4)), "getPreSelection", function() {
      ...
      return i2.props.inline || i2.isCalendarOpen() ? import_react.default.createElement(Xt, { ref: function(e3) {
        i2.calendar = e3;
      ...
      return import_react.default.cloneElement(o, (ye(ye(ye(ye(ye(ye(ye(ye(ye(ye(t5 = {}, a4, function(e3) {
        i2.input = e3;
      ...
      return !n || null == a4 && null == s4 && null == p ? null : import_react.default.createElement("button", { type: "button", className: (0, import_classnames.default)("react-datepicker__close-icon", d3, { "react-datepicker__close-icon--disabled": o }), disabled: o, "aria-label": h3, onClick: i2.onClearClick, title: c2, tabIndex: -1 });
  ...
  return fe(s3, [{ key: "componentDidMount", value: function() {
    ...
    return import_react.default.createElement("div", { className: "react-datepicker__input-container".concat(r2 ? " react-datepicker__view-calendar-icon" : "") }, r2 && import_react.default.createElement(qt, ve({ icon: n, className: "".concat(o, " ").concat(s4 && "react-datepicker-ignore-onclickoutside") }, a4 ? { onClick: this.toggleCalendar } : null)), this.state.isRenderAriaLiveMessage && this.renderAriaLiveRegion(), this.renderDateInput(), this.renderClearButton());
  } }, { key: "render", value: function() {
    var t4 = this.renderCalendar();
    if (this.props.inline)
      return t4;
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react.default.createElement($t, { enableTabLoop: this.props.enableTabLoop }, import_react.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t4)) : null;
      return this.state.open && this.props.portalId && (r2 = import_react.default.createElement(Ut, { portalId: this.props.portalId, portalHost: this.props.portalHost }, r2)), import_react.default.createElement("div", null, this.renderInputContainer(), r2);
    }
    return import_react.default.createElement(Gt, { className: this.props.popperClassName, wrapperClassName: this.props.wrapperClassName, hidePopper: !this.isCalendarOpen(), portalId: this.props.portalId, portalHost: this.props.portalHost, popperModifiers: this.props.popperModifiers, targetComponent: this.renderInputContainer(), popperContainer: this.props.popperContainer, popperComponent: t4, popperPlacement: this.props.popperPlacement, popperProps: this.props.popperProps, popperOnKeyDown: this.onPopperKeyDown, enableTabLoop: this.props.enableTabLoop });
  } }], [{ key: "defaultProps", get: function() {
