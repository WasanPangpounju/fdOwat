...
import logoFile from '../../assets/images/owatLogo.png';
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ textAlign: 'center' }}>
          <Text style={{ fontSize: 14, marginBottom: 5 }}>
            รายงานสรุปการจ่ายค่าจ้างพิเศษในวันหยุดทุกหน่วยงาน
          </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={[styles.tableColWide, { width: '40%' }]}>
            ...
            {workplaceSummary.map((workplace, index) => (
